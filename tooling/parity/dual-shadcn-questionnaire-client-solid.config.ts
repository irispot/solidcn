...
const testFile = resolve(root, 'shadcn-ui/packages/react/src/questionnaire/questionnaire.test.tsx');
...
const unchangedFixture: Plugin = {
  name: 'unchanged-shadcn-questionnaire-client-fixture',
  enforce: 'pre',
...
export default defineConfig({
  ...
  resolve: {
    ...
    alias: [
      ...
      { find: /^react-dom\/client$/, replacement: tooling('shadcn-questionnaire-dom-create.ts') },
      { find: /^@solid-cn\/parity-fixture\/jsx(?:-dev)?-runtime$/, replacement: tooling('fixture-runtime.ts') },
    ],
  },
  test: {
    name: 'unchanged-shadcn-questionnaire-native-solid-client',
    environment: 'jsdom',
    include: ['shadcn-ui/packages/react/src/questionnaire/questionnaire.test.tsx'],
    maxWorkers: 1,
