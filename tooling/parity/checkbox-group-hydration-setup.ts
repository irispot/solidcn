...
const service = await server.ssrLoadModule('/tooling/parity/checkbox-group-hydration-ssr-service.ts');
(globalThis as any).__solidCnCheckboxSsr = service.renderCheckboxGroupToString;
afterAll(async () => {
