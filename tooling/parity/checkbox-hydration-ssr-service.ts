import { Checkbox, Field } from '../../base-ui/packages/solid/src/controls';
...
export function renderCheckboxToString(
  ...
  console.info('Native Solid Checkbox SSR evidence:', JSON.stringify({
